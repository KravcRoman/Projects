...
<h5 align="center">В папке <a href="https://github.com/KravcRoman/Projects/tree/main/GitHub/Freelancing" target="_blank">Freelancing</a> - часть проектов, которые были выполнены на фрилансе и тестовые для трудоустройства. Практически к каждому проекту есть ТЗ в файле с окончанием -  <b>Task.txt </b></h5>
